...
the child and the stale download is cleaned up. This is BLOCKER 2 from
audit #1.
...
- [BLOCKER 2 — kill_on_drop signal handling](/architecture/security#pbs-restore-supervision)
