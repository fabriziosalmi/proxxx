...
|---|---|---|
| OS · SIGTERM initiates clean WAL flush and graceful exit (V21) | ❌ | 0 |
...
| Memory · TUI `pop_view` triggers `shrink_to_fit` dropping old data (V26.7) | ❌ | 0 |
...
| Proxmox Quirks · `pvestatd` freeze detected via uptime drift (V27.6) | ❌ | 0 |
| Proxmox Quirks · HA-managed VM destructive ops blocked locally (V27.1) | ❌ | 0 |
