...
impl PbsClient {
    ...
    pub async fn new(cfg: PbsConfig, cli_secret: Option<&str>) -> Result<Self> {
        ...
        // Vector 16 — the secret leaves our zeroizing envelope here
        ...
        let http = Client::builder()
            ...
            // V29.1 — TCP keepalive against firewall half-open
    ...
    async fn get<T: DeserializeOwned>(&self, path: &str) -> Result<T> {
        ...
        // Vector 14: same bounded-body read as the PVE client. A
