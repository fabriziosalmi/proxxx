...
//!
//! audit (TOCTOU): the `.vv` file contains the SPICE password
...
mod tests {
    ...
    /// regression: each call must produce a UNIQUE path. With
    ...
    /// regression: confirm the temp file lives in the system
