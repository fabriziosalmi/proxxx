...
const fn is_retryable_status(s: StatusCode) -> bool {
    matches!(
        s,
...
impl PxClient {
    ...
    async fn post<T: DeserializeOwned + Send + 'static>(
        ...
        if !status.is_success() {
            ...
            // banner the way GETs already could (V26.4 audit closed
...
impl ProxmoxGateway for PxClient {
    ...
    async fn stop_guest(
        ...
        // here).
        //
        // Live-cluster regression (2026-05-04 batch 3): an earlier
    ...
    async fn list_notification_endpoints(
        ...
        // PVE 8/9 quirk discovered live (2026-05-04 batch 2.5):
    ...
    async fn resize_disk(
        ...
        if !status.is_success() {
            ...
            // written before the V26.4 typed-error pass).
