...
fn main() -> Result<()> {
    ...
    //
    // Vector 22 (macro audit) — capped log rotation. Without
    ...
    //
    // V28.4 (audit) — path traversal via $HOME injection.
    //
    ...
    // BLOCKER 3: install the flight-recorder panic hook BEFORE the
