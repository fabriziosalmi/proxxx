...
//!   NOT covered by this library yet — see features.md backlog.
...
/// the reducer / CLI. This is BLOCKER 1 from the v1.0.0
...
mod tests {
    ...
    fn checksum_when_pinned_is_well_formed_lowercase_hex_and_not_placeholder() {
        // BLOCKER 1 invariant: if a checksum is pinned (Some), it MUST
