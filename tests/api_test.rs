...
mod tests {
    ...
    async fn stop_guest_never_sends_force_stop_param() {
        // Live-cluster regression (2026-05-04 batch 3): PVE 8/9 rejects
    ...
    /// Verifies the URL the client constructs AND that the V25-pattern
    ...
    async fn suspendall_node_404_surfaces_typed_notfound_on_old_pve() {
        ...
        // V26.4 typed-error pass + Phase 7 write-path completion.
        let typed = err
            .chain()
    ...
    async fn list_backup_jobs_tolerates_missing_optional_fields() {
        // V25-audit pattern: every field is `#[serde(default)]`. A PVE
    ...
    async fn get_node_time_accepts_null_timezone() {
        // Live-cluster regression (2026-05-04 / pve-test-1..3): a fresh
    ...
    async fn get_cluster_log_accepts_string_uid_and_extra_id_field() {
        // Live-cluster regression (2026-05-04): real PVE returns
        //   "uid": "2957"            (JSON string, not number)
        //   "id": "2957:pve-test-1"  (extra field not in our struct)
    ...
    async fn list_notification_endpoints_does_not_use_catalog_endpoint() {
        // Live-cluster regression (2026-05-04): the buggy old impl
    ...
    async fn create_cluster_storage_accepts_object_response_not_just_null() {
        // Live-cluster regression (2026-05-04 batch 2.5): real PVE
    ...
    async fn list_cluster_corosync_nodes_accepts_string_numerics() {
        // Live-cluster regression (2026-05-04 / pve-test-1..3): real
        // PVE returns
