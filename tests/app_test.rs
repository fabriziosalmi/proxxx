...
mod tests {
    ...
    fn test_download_iso_pinned_entry_dispatches_side_effect() {
        // After ISO supply-chain hardening was closed by real upstream pinning, every
    ...
    fn test_download_iso_debian_uses_sha512_pin() {
        ...
        // schema extension supports both algorithms; this
    ...
    fn test_download_iso_curated_resolves_node_when_empty() {
        ...
        // state. With all entries now pinned (ISO supply-chain hardening closed), the
