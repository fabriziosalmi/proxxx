...
# ── Step 11: Cluster-level mutation lifecycle (batch 2) ──
# Exercises the cluster-scope CRUD shipped in the 2026-05-04 PVE
# expansion. Every object uses the `proxxx-mut-` prefix; the
