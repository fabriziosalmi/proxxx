...
- A 1-3 node PVE cluster (lab is fine — `pve-test-1`, `pve-test-2`,
  `pve-test-3`).
- VMID 9999 free for the LXC mutation lifecycle.
- Optionally VMID 9998 free for QEMU lifecycle (batch 3).
- Optionally a QGA-enabled QEMU VM for batch 4 — the env file
  documents the alpine apk one-liner.
